...
<body id="page-top">
    ...
    <!-- Page Heading -->
        ...
        <form action="myPageModifyView.employeeDo?employeeCode=<%= userCode%>" method="post"> 
...
<div class="container mt-3">
  <div class="card" >
    <img class="card-img-top" src="img/undraw_profile.svg" alt="Card image" style="width: 300px">
    <div class="card-body">
      <h5 class="card-title">
